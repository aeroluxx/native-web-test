...
import { ScrollView, StyleSheet, Platform, Text, Dimensions } from 'react-native'
    ...
    return (
      <ScrollView contentContainerStyle={styles.container} scrollEnabled={this.state.scrollEnabled}>
        ...
        <Svg width={Dimensions.get('window').width} height={300}>
          <VictoryLegend x={5} y={10} standalone={false} data={legendData} style={legendStyle} />
          <VictoryLegend x={5} y={200} data={legendData} standalone={false} itemsPerRow={3} style={legendStyle} />
        </Svg>
        ...
        <VictoryPie endAngle={90} innerRadius={90} padAngle={5} startAngle={-90} />
        <VictoryPie
          style={{
            labels: {
              fill: 'white',
        ...
        <VictoryLine
          data={[{ x: 0, y: 1 }, { x: 1, y: 3 }, { x: 2, y: 2 }, { x: 3, y: 4 }, { x: 4, y: 3 }, { x: 5, y: 5 }]}
        />
        ...
        <VictoryArea interpolation="basis" animate={{ duration: 1500 }} data={this.state.data} />
        ...
        <VictoryBar data={[{ x: 1, y: 1 }, { x: 2, y: 2 }, { x: 3, y: 3 }, { x: 4, y: 2 }, { x: 5, y: 1 }]} />

        <VictoryGroup width={300} height={375} offset={20} colorScale="qualitative">
        ...
        <VictoryScatter
          data={[{ x: 1, y: 3 }, { x: 2, y: 5 }, { x: 3, y: 4 }, { x: 4, y: 2 }, { x: 5, y: 5 }]}
          size={8}
          symbol="star"
          style={{
            data: {
        ...
        <Svg width={320} height={320}>
          <VictoryAxis width={320} height={320} domain={[-10, 10]} crossAxis offsetY={160} standalone={false} />
          <VictoryAxis
            dependentAxis
            width={320}
            height={320}
        ...
        <VictoryAxis dependentAxis padding={{ left: 50, top: 20, bottom: 20 }} scale="log" domain={[1, 5]} />
